<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="KNSquare.index" %>
            ...
            <div class="col-sm-12 col-md-12 col-lg-8">
              <form id="contact_form" action="" method ="post" runat="server">
                ...
                <div class="row">
                  ...
                  <asp:TextBox id="UserName_tb" class="form-input w-100" name="User-name" placeholder="UserName" runat="server"></asp:TextBox>
                  </div>
                  <div class="col">
                    <asp:TextBox id="EMail_tb" class="form-input w-100" name="email" placeholder="E-Mail" runat="server"></asp:TextBox>
                  </div>  
                </div>
...
<asp:TextBox id="Password_tb" class="form-input w-100" name="Password" placeholder="Password" runat="server"></asp:TextBox>
</div>
<div class="col">
<asp:TextBox id="Mobile_tb" class="form-input w-100" name="Mobile" placeholder="Mobile Number" runat="server"></asp:TextBox>
</div>
</div>


                <asp:Button class="btn-grad w-100 text-uppercase" runat="server" Text="Register" OnClick="Unnamed1_Click"></asp:Button>
